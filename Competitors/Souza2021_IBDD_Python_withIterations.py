...
import pandas as pd
import numpy as np
from Competitors.HelperFiles.Souza2021_IBDD_detectors import IBDD
...
for iteration in range(n_iterations):
    ...
    all_times_per_example.append(time/len(test_X))
...
# 5. Save results in file from iterations
# Create file name
